...
class DataService {
    ...
    private let shirts = [
        Product(title: "Devslopes Logo Shirt Balck", price: "$18", imageName: "shirt01.png"),
        ...
        Product(title: "Devslopes Logo Shirt Balck", price: "$18", imageName: "shirt05Kickflip Studios Black.png")
    ]
